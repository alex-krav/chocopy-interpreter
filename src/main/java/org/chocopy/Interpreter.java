...
class Interpreter implements Expr.Visitor<Object>, Stmt.Visitor<Void> {
    ...
    public Object visitSuperExpr(Expr.Super expr) {
        ...
        ChocoPyClass superclass = (ChocoPyClass)environment.getAt(
                distance, "super");

        ChocoPyInstance object = (ChocoPyInstance)environment.getAt(
                distance - 1, "this");

        ChocoPyFunction method = superclass.findMethod(expr.method.lexeme);
